...
- Generates complete original story drafts with a beginning, conflict, development, climax, resolution, and `Moral of the Story`.
...
python -m paws_tales.cli generate-story --language en --manifest
python -m paws_tales.cli generate-story --language hi --manifest
```
